...
HD_PWD='/home/jsc/Documents/Xilinx/VHDL_Designs/RAM_8x8/RAM_8x8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_8x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_8x8.tcl
