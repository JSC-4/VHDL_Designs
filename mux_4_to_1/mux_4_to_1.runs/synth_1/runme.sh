...
HD_PWD='/home/jsc/Documents/Xilinx/VHDL_Designs/mux_4_to_1/mux_4_to_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4_to_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_4_to_1.tcl
